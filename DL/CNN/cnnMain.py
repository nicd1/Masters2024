...
cnn_model.fit(x=X_train_scaled, y=Y_train, epochs=10, validation_data=(X_test_scaled, Y_test), callbacks=[cb])


loss, accuracy, recall, precision, f1_score = cnn_model.evaluate(X_test_scaled, Y_test)
